...
//add a method to check for dup customer (by email)
	public static void checkForDupCustomer(String email, Map<String,Customer> customerList) throws CMSException {
...
//1. parse string(plan) -- > enum
	...
	public static Customer validateCustomerInputs(String firstName, String lastName, String email, String password,
			double regAmount, String dob, String plan, Map<String,Customer> customers) throws CMSException {
		// 1 . check for dup
